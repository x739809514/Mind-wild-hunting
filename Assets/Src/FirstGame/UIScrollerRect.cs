...
{
    [AddComponentMenu("UI/UIScrollerRect", 37)]
    [SelectionBase]
    [ExecuteAlways]
    ...
    /// </summary>
    /// <remarks>
    /// UIScrollerRect will not do any clipping on its own. Combined with a Mask component, it can be turned into a scroll view.
    /// </remarks>
    public class UIScrollerRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
        ...
        /// {
        ///     public UIScrollerRect myUIScrollerRect;
        ...
        ///         if (option == 0)
        ///         {
        ///             myUIScrollerRect.movementType = UIScrollerRect.MovementType.Clamped;
        ///         }
        ///         else if (option == 1)
        ///         {
        ///             myUIScrollerRect.movementType = UIScrollerRect.MovementType.Elastic;
        ///         }
        ///         else if (option == 2)
        ///         {
        ///             myUIScrollerRect.movementType = UIScrollerRect.MovementType.Unrestricted;
        ///         }
        ///     }
        /// }
        /// </code>
        ...
        [Serializable]
        /// <summary>
        /// Event type used by the UIScrollerRect.
        /// </summary>
        public class UIScrollerRectEvent : UnityEvent<Vector2> {}

        [SerializeField]
        private RectTransform m_Content;

        /// <summary>
        /// The content that can be scrolled. It should be a child of the GameObject with UIScrollerRect on it.
        /// </summary>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        ///     public void Start()
        ///     {
        ///         // assigns the contect that can be scrolled using the UIScrollerRect.
        ///         myUIScrollerRect.content = scrollableContent;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        ///         if (myUIScrollerRect.horizontal == true)
        ///         {
        ...
        ///         if (myUIScrollerRect.vertical == true)
        ///         {
        ...
        ///         myUIScrollerRect.elasticity = 3.0f;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        /// </summary>
        /// <remarks>
        /// Inertia means that the UIScrollerRect content will keep scrolling for a while after being dragged. It gradually slows down according to the decelerationRate.
        /// </remarks>
        ...
        ///         myUIScrollerRect.decelerationRate = 5.0f;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Optional Scrollbar object linked to the horizontal scrolling of the UIScrollerRect.
        /// </summary>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the UIScrollerRect, allowing you to scroll in the horizontal axis.
        ///         myUIScrollerRect.horizontalScrollbar = newScrollBar;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Optional Scrollbar object linked to the vertical scrolling of the UIScrollerRect.
        /// </summary>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        ///     public void Start()
        ///     {
        ///         // Assigns a scroll bar element to the UIScrollerRect, allowing you to scroll in the vertical axis.
        ///         myUIScrollerRect.verticalScrollbar = newScrollBar;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        [SerializeField]
        private UIScrollerRectEvent m_OnValueChanged = new UIScrollerRectEvent();

        /// <summary>
        /// Callback executed when the position of the child changes.
        /// </summary>
        /// <remarks>
        /// onValueChanged is used to watch for changes in the UIScrollerRect object.
        ...
        /// The UnityEvent.AddListener API for UI.UIScrollerRect._onValueChanged takes a Vector2.
        ///
        ...
        /// shows how this can be done.The script is attached to the UIScrollerRect object.
        /// </remarks>
        /// <example>
        /// <code>
        /// using UnityEngine;
        ...
        /// {
        ///     static UIScrollerRect UIScrollerRect;
        ///
        ///     void Start()
        ///     {
        ///         UIScrollerRect = GetComponent<UIScrollerRect>();
        ///         UIScrollerRect.onValueChanged.AddListener(ListenerMethod);
        ///     }
        ///
        ...
        /// </code>
        /// </example>
        public UIScrollerRectEvent onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
        ...
        /// 跳转到指定方向(横向)
        /// </summary>
        public void HorizontalNavigate(int index=-1)
        {
            if (content.childCount>0)
            {
                float cellX = content.GetChild(0).GetComponent<RectTransform>().sizeDelta.x;
                if (index == -1)
                {
                    index = content.childCount;
                }

                float length = index * cellX;
                float viewH = index * cellX - this.GetComponent<RectTransform>().sizeDelta.x;
                if (length<viewH)
                {
                    length = viewH;
                }
                content.localPosition=new Vector3(length,0,0);
            }
        }
        ...
        ///     public void Start()
        ///     {
        ///         //Checks if the UIScrollerRect called "myUIScrollerRect" is active.
        ///         if (myUIScrollerRect.IsActive())
        ///         {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_ViewBounds != m_PrevViewBounds || m_ContentBounds != m_PrevContentBounds || m_Content.anchoredPosition != m_PrevPosition)
            {
                ...
                UISystemProfilerApi.AddMarker("UIScrollerRect.value", this);
        ...
        /// <summary>
        /// Helper function to update the previous data fields on a UIScrollerRect. Call this before you change data in the UIScrollerRect.
        /// </summary>
        ...
        ///         myUIScrollerRect.normalizedPosition = myPosition;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        ///         myUIScrollerRect.horizontalNormalizedPosition = 0.5f;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        ///         myUIScrollerRect.verticalNormalizedPosition = 0.5f;
        ///     }
        /// }
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Calculate the bounds the UIScrollerRect should be using.
        /// </summary>
